<?php
    ...
    abstract class str{
        ...
        public static function fromEnv($str){
            if(is_array($str))          $str = array_map(array('str', 'fromEnv'), $str);
            elseif(is_object($str))     $str = (object)array_map(array('str', 'fromEnv'), (array)$str);
            else                        $str = self::stripslashes($str);
            return $str;
        }
