<?php self::header(); ?>
    <form role="form" class="form-signin" method="post">
        ...
        <input type="text" class="form-control" placeholder="<?php echo \PHPTools\Libraries\I18n::__('Adresse email'); ?>" name="email" value="<?php echo \PHPTools\Libraries\Env::post('email'); ?>" autofocus />
